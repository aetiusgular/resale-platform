...
- Tokens live in `@theme` in `app/globals.css`. Six colours, three fonts, type scale 12/14/16/20/28/40, radius 2px, 8px grid, 44px controls. No gradients, no dark mode.
- **All listing data renders in `--font-mono` (Space Mono).** No exceptions.
