...
// ─── long copy (QA for the PDP clamp + READ FULL reading pane, cards, inbox rows) ───────────
// The sell form caps a description at 1000 chars; the DB does not. paf = a 549-word "seller
// wall" far past the cap (the reader's stress case), puffer = exactly the realistic max as one
// unbroken paragraph, kozaburo = the ~130-word "medium" from the R5B mocks, helmut = list-style
// line breaks plus an unbroken 70-char style code (overflow/wrap check), soloist = a long
// description on a SOLD listing. ANND_TITLE = a 109-char title (form cap 120) for card,
// inbox-row and order-row truncation.
const LONG = {
  paf: "Post Archive Faction 5.0+ Center reversible curved jacket in black technical nylon, size S. This is the centre-line version from the 5.0 season: the one with the fully reversible construction where the matte shell and the panelled lining are both finished sides, so it is genuinely two jackets. I bought it new from AGMNT in San Jose in March, have the receipt and the original hangtag, and wore it maybe five times over the spring before the weather turned.\n\nFit and sizing. PAF runs roomy in the body and this is a size S, which on me (5'11\", 165 lb, usually a 38 chest) fits like a relaxed S or a slim M. The curved panelling pulls the shoulder seam slightly forward, which is the design, not a fit problem. Sleeves end right at the wrist bone with the cuff cinched. Pit to pit is 21.5 inches flat, back length 26 inches from the collar seam, shoulder 19 inches seam to seam, sleeve 25 inches from the shoulder seam. Measurements are in the block below and I am happy to take more if you need a specific one.\n\nCondition, area by area. Shell: clean, no scuffs, no snags, no pilling on the nylon. Lining side: clean, one very faint pressure mark near the inside left pocket from a phone that does not show unless you look for it under raking light (photo 6). Zips: both the main two-way zip and the pocket zips glide with no catching. Elastic lining: full stretch, no wave or looseness. Cuffs and hem: no fraying. Smell: none, stored on a wide hanger in a garment bag, smoke-free and pet-free home. I would call it 9/10 if the site still had grades; the only reason it is not a 10 is the pressure mark and the fact that it has been worn.\n\nWhat is included. The jacket, the original hangtag with the PAF barcode still attached by its string, the spare zip pull that came in the pocket, and a copy of the receipt with my details blacked out. No dust bag (PAF did not ship one for this style). The garment bag is mine and does not come with it.\n\nShipping and handling. Ships from San Jose, CA within two business days of payment, folded once in tissue inside a poly mailer inside a box, because nylon creases if it is packed tight. US buyers pay the calculated USPS Ground Advantage rate shown at checkout; I do not ship internationally on this one right now. Tracking goes on the order the moment it leaves. If the buyer confirms delivery within the escrow window everything releases normally; if there is any problem at all message me first and we will sort it out through the platform.\n\nWhy I am selling. I picked up the grey colourway of the same jacket a month ago and I do not need two, that is the whole story. Offers are welcome through the offer button (please, not in the chat), but I am not going to take less than the low $300s because these are hard to find in an S and the black is the one everybody wants. Thanks for reading all of this, I know it is a lot, I would rather over-explain than have a return.",
  puffer: "Rick Owens x Moncler funnel neck down puffer, olive, size M, from the second collaboration drop. Worn one winter in LA, which means maybe fifteen wears total. Down is still lofty with no cold spots or leaks, the funnel zip runs all the way up and locks, the internal drawcord at the hem works, and the snap placket over the zip has all snaps present. Shell is the matte nylon with no shine loss, no scuffs and no repairs. There is a small, faint mark on the inside of the left cuff lining from a watch clasp, shown in photo 4, which is the only flaw I can find after going over it twice. Authentic, bought at Moncler Beverly Hills in person, receipt available on request, tags and the Moncler QR card are included. Fit is oversized as designed: I am 6'0\" and 175 lb and the M is roomy enough to layer a hoodie under. Ships from Los Angeles within two business days, double boxed, with tracking on the order. Reasonable offers considered through the offer button. No trades, no holds, no lowballs.",
  kozaburo: "Kozaburo honeycomb sashiko trucker, made in Japan, size 2. Artisan honeycomb sashiko stitching across the whole body, type-two trucker pattern with the flared hem opening that Kozaburo does. Worn a handful of times, no fading yet, the indigo is still deep and even. All buttons original, no missing rivets.\n\nSizing: a 2 is close to a US S/M and sits a little short in the body because of the flare. I am 172 cm and it fits me as a cropped jacket over a tee. Shoulder is unstructured so it drapes rather than squares off.\n\nShips from Tokyo with full tracking. North America is priced at the region rate shown; duties and import fees are the buyer's responsibility. Please allow one to two weeks in transit. Bundles with the wide leg jean are possible, message me before you buy.",
  helmut: "Helmut Lang SS24 seatbelt bondage bomber, black nylon, tagged XS but oversized: fits a modern S/M. All eight seatbelt straps and both metal buckles present and working. Two-way front zip, quilted lining, no marks, no odours.\n\nStyle code: HL-SS24-M-JKT-SEATBELT-BONDAGE-BOMBER-BLK-XS-0001174623-RUNWAY-LOOK-19\n\nMeasured flat, in inches:\nPit to pit 23\nLength 24 from the back collar seam\nShoulder 20 seam to seam\nSleeve 25 from the shoulder seam\nHem opening 20 relaxed, 17 cinched\nStrap length 28 each, buckle to end\n\nCondition notes:\n- shell clean, no snags\n- one strap has light surface wear on the webbing from being tightened, see photo 4\n- lining clean\n- zip pull original\n- interior label crisp, size tag intact\n- no repairs, no alterations\n\nInternational: Canada, the UK, Europe, Asia and Australia/NZ are priced per region on this listing and I buy the label myself with tracking. Duties are on the buyer. Domestic US buyers get the calculated rate at checkout. Everything else about the transaction goes through the platform, so please keep the conversation here.",
  soloist: "TAKAHIROMIYASHITA TheSoloist AW23 cropped reversible bomber, size 48. This is the one with the internal button mechanism that lets you pull the body in for a tighter fit, so it wears two ways on top of being reversible: full cropped M-ish volume, or cinched. Both faces are clean nylon, the padding is even with no clumping, the ribbed hem and cuffs have full recovery. All buttons of the mechanism are present. There is no wear on the elbows or the underarms, which is where these usually show it, and the inside label is crisp. Bought from AGMNT, worn twice to shows, then it sat. I am including the brand hangtag. Ships from San Jose within two business days, tracked, packed flat in a box so the padding does not crease. Fits a cropped medium; if you are between sizes the mechanism covers it. Message me if you want more photos of the button system, it is hard to photograph but easy to understand in hand.",
}
const ANND_TITLE = "Ann Demeulemeester AW2006 'Patrick' Black Denim Trucker Jacket with Signature Ribbon Ties, Size 46 (fits S/M)"
...
const LISTINGS = [
  ...
  { key: 'rick-puffer', seller: 'mara', handles: ['rick-owens-moncler-funnel-neck-puffer'], n: 4, title: 'Rick Owens x Moncler Funnel Neck Puffer', brand: 'RICK OWENS', category: 'Outerwear', subcategory: 'Other outerwear', department: 'menswear', size: 'M', color: 'Olive', price: 105000, was: [130000, 115000], dropAgo: 2, views: 402, created: 33, desc: LONG.puffer, meas: { 'PIT TO PIT': 25, LENGTH: 30, SHOULDER: 22, SLEEVE: 27 } },
