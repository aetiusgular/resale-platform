...
const TITLES: Record<string, string> = {
  profile: 'Profile', address: 'Shipping address', sizes: 'My sizes', notifications: 'Notifications', phone: 'Phone', tiers: 'Fees & tiers',
}
...
/** /settings/<profile|address|sizes|notifications|phone|tiers> */
