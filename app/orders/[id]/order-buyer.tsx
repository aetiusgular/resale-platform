...
export default function OrderBuyerView({ order, listing, sellerUsername }: Props) {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{ border: '1px solid var(--color-line)', borderRadius: 2 }}>
            ...
            <div style={{ padding: '0 16px 16px', display: 'flex', flexDirection: 'column', gap: 7 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--color-ink-soft)' }}><span>BUYER FEE 2%</span><span>{formatCents(order.buyer_fee_cents)}</span></div>
